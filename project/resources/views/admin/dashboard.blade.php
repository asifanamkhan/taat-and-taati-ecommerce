...
<div class="content-area">
    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg1">
                <div class="left">
                    <h5 class="title">{{ __('Today\'s Total Orders') }} </h5>
                    <span class="number">{{count($todays_total_orders)}}</span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-truck-alt"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg2">
                <div class="left">
                    <h5 class="title">{{ __('Today\'s Total Revenue') }}</h5>
                    <span class="number">{{$todays_total_payment}}</span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-dollar"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    <h5 class="title">{{ __('Today\'s Ordered Products') }}</h5>
                    <a href="{{route('admin.order.tdayproducts')}}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-check-circled"></i>
