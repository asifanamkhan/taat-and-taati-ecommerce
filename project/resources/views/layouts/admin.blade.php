			...
			<div class="wrapper">
				...
				<nav id="sidebar" class="nav-sidebar">
					<ul class="list-unstyled components" id="accordion">
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
								...
								<li>
									...
									<li>
										<a
												href="{{ route('admin-prod-active') }}"><span>{{ __('Activated Product') }}</span></a>
									</li>
								<li>
									<a href="{{ route('admin-prod-package-index') }}"><span>{{ __('Package') }}</span></a>
								</li>
									<li>
										<a href="{{ route('admin-prod-barcode-generate') }}"><span>{{ __('Barcode/label generate') }}</span></a>
									</li>
							</ul>
						</li>
						...
						{{--<li>--}}
							{{--<a href="#ivnevtory" class="accordion-toggle wave-effect" data-toggle="collapse"--}}
							   {{--aria-expanded="false">--}}
								{{--<i class="fas fa-fw fa-newspaper"></i>{{ __('Inventory') }}--}}
							{{--</a>--}}
							{{--<ul class="collapse list-unstyled" id="ivnevtory" data-parent="#accordion">--}}
								{{--<li>--}}
									{{--<a href="{{ route('admin-inventory-create') }}"><span>{{ __('Manage inventory') }}</span></a>--}}
								{{--</li>--}}
								{{--<li>--}}
									{{--<a href="{{ route('admin-inventory-index') }}"><span>{{ __('History') }}</span></a>--}}
								{{--</li>--}}
								{{--<li>--}}
									{{--<a href="{{ route('admin-inventory-sent-stock-request') }}"><span>{{ __('Sent stock request') }}</span></a>--}}
								{{--</li>--}}
								{{--<li>--}}
									{{--<a href="{{ route('admin-inventory-receive-stock-request') }}"><span>{{ __('Received stock request') }}</span></a>--}}
								{{--</li>--}}
								{{--<li>--}}
									{{--<a href="{{ route('admin-inventory-receive-stock-request-refund') }}"><span>{{ __('Refund stock request') }}</span></a>--}}
								{{--</li>--}}
							{{--</ul>--}}
						{{--</li>--}}

						<li>
							<a href="#pos" class="accordion-toggle wave-effect" data-toggle="collapse"
							   aria-expanded="false">
								<i class="fas fa-fw fa-newspaper"></i>{{ __('POS') }}
							</a>
							<ul class="collapse list-unstyled" id="pos" data-parent="#accordion">
								<li>
									<a target="_blank" href="https://pos-agromars.vercel.app/"> {{ __('Terminal') }}</a>
								</li>
								<li>
									<a href="{{route('pos-sale-history')}}"> {{ __('Sale history') }}</a>

								</li>
								<li>
									<a href="{{route('pos-sale-report')}}"> {{ __('Report') }}</a>
								</li>
								@if(Auth::guard('admin')->user()->IsAdmin() || Auth::guard('admin')->user()->role == 'warehouseAdmin' )
									<li>
										<a href="{{route('pos-admin-index')}}"> {{ __('Pos admin create') }}</a>
									</li>
								@endif
							</ul>
						</li>
						...
						{{--<li>--}}
							{{--<a href="{{ route('admin-warehouse-index') }}" class=" wave-effect"><i--}}
										{{--class="fas fa-user-secret"></i>{{ __('Create Warehouse') }}</a>--}}
						{{--</li>--}}
