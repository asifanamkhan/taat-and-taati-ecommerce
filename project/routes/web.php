...
Route::prefix('admin')->group(function() {
  ...
  Route::post('/order-adjust', 'Admin\OrderController@adjust')->name('admin-order-adjust');
  Route::post('/order/inventory', 'Admin\OrderController@inventory')->name('admin-order-inventory');
  ...
  Route::get('/products/active', 'Admin\ProductController@active')->name('admin-prod-active');
  Route::get('/products/active/datatable', 'Admin\ProductController@activeDatatable')->name('admin-prod-active-datatables');
  ...
  //Package
    Route::get('/products/package/create', 'Admin\ProductController@packageCreate')->name('admin-prod-package-create');
    Route::post('/products/package/store', 'Admin\ProductController@packageStore')->name('admin-prod-store-package');
    Route::get('/products/package/index', 'Admin\ProductController@packageIndex')->name('admin-prod-package-index');
    Route::get('/products/package/datatable', 'Admin\ProductController@packageDatatable')->name('admin-prod-package-datatable');
    Route::get('/products/package/edit/{id}', 'Admin\ProductController@packageEdit')->name('admin-prod-package-edit');
    Route::post('/products/package/product/update/{id}', 'Admin\ProductController@packageProductUpdate')->name('admin-prod-package-update');
    Route::get('/products/barcode/print/{id}', 'Admin\ProductController@productBarcodePrint')->name('admin-prod-barcode-print');
    Route::get('/products/barcode/generate', 'Admin\ProductController@productBarcodeGenerate')->name('admin-prod-barcode-generate');
    Route::post('/products/barcode/generate/create', 'Admin\ProductController@productBarcodeGenerateCreate')->name('admin-prod-barcode-generate-create');
...
// Currency Settings
  ...
  //------------ Ware house SECTION ------------
  Route::get('/warehouse', 'Admin\StaffController@warehouse')->name('admin-warehouse-index');
  Route::get('/warehouse/create', 'Admin\StaffController@warehouseCreate')->name('admin-warehouse-create');
  Route::post('/warehouse/store', 'Admin\StaffController@warehouseStore')->name('admin-warehouse-store');
  Route::get('/warehouse/datatables', 'Admin\StaffController@warehouseDatatables')->name('admin-warehouse-datatables');
  Route::get('/warehouse/show/{id}', 'Admin\StaffController@warehouseShow')->name('admin-warehouse-show');

  //------------ Ware house SECTION ENDS------------
...
//inventory
Route::get('/inventory', 'Admin\InventoryController@index')->name('admin-inventory-index');
Route::get('/inventory/create', 'Admin\InventoryController@create')->name('admin-inventory-create');
Route::post('/inventory/store', 'Admin\InventoryController@store')->name('inventory-store');
Route::get('/inventory-datatables/{id}', 'Admin\InventoryController@datatables')->name('admin-inventory-datatables');
Route::get('/inventory/details/{id1}/{id2}', 'Admin\InventoryController@details')->name('inventory-details');
Route::get('/inventory/stock/request/{id1}/{id2}', 'Admin\InventoryController@stockRequest');
Route::post('/inventory/stock/request/store', 'Admin\InventoryController@stockRequestStore')->name('inventory-stock-request-store');
Route::get('/inventory/sent/stock/request', 'Admin\InventoryController@stockRequestSent')->name('admin-inventory-sent-stock-request');
Route::get('/inventory/sent/stock/request/edit/{id}', 'Admin\InventoryController@stockRequestSentEdit')->name('admin-inventory-sent-stock-request-edit');
Route::post('/inventory/sent/stock/request/update/{id}', 'Admin\InventoryController@stockRequestSentUpdate')->name('inventory-stock-request-update');
Route::get('/inventory/sent/stock/request/datatable', 'Admin\InventoryController@stockRequestSentDatatable')->name('admin-inventory-sent-stock-request-datatable');
Route::get('/inventory/receive/stock/request', 'Admin\InventoryController@stockRequestRecieved')->name('admin-inventory-receive-stock-request');
Route::get('/inventory/receive/stock/request/status/{id}', 'Admin\InventoryController@stockRequestRecievedStatus')->name('admin-inventory-receive-stock-request-status');
Route::get('/inventory/receive/stock/request/status/sent/{id}', 'Admin\InventoryController@stockRequestRecievedStatusSent')->name('admin-inventory-receive-stock-request-status-sent');
Route::post('/inventory/receive/stock/request/status/change/{id}', 'Admin\InventoryController@stockRequestRecievedStatusChange')->name('inventory-stock-request-status-change');
Route::get('/inventory/receive/stock/request/datatable', 'Admin\InventoryController@stockRequestRecievedDatatable')->name('admin-inventory-receive-stock-request-datatable');
Route::get('/inventory/receive/stock/request/refund', 'Admin\InventoryController@stockRequestRecievedRefund')->name('admin-inventory-receive-stock-request-refund');
Route::get('/inventory/stock_request/invoice/{id}', 'Admin\InventoryController@stockRequestInvoice')->name('admin-inventory-stock-request-invoice');
Route::get('/inventory/stock_request/invoice/print/{id}', 'Admin\InventoryController@stockRequestInvoicePrint')->name('admin-inventory-stock-request-invoice-print');

Route::get('/pos', 'Admin\PosController@index')->name('pos-admin-index');
Route::get('/pos/datatable', 'Admin\PosController@datatable')->name('pos-admin-datatables');
Route::get('/pos/create', 'Admin\PosController@adminCreate')->name('pos-admin-create');
Route::post('/pos/store', 'Admin\PosController@adminStore')->name('pos-admin-store');
Route::get('/pos/show/{id}', 'Admin\PosController@adminShow')->name('pos-admin-show');
Route::get('/pos/sale/history', 'Admin\PosController@saleHistory')->name('pos-sale-history');
Route::get('/pos/sale/datatable', 'Admin\PosController@saleDatatable')->name('pos-sale-datatable');
Route::get('/pos/sale/details/{id}', 'Admin\PosController@posDetails')->name('pos-details-show');
Route::get('/pos/sale/report', 'Admin\PosController@posReport')->name('pos-sale-report');
Route::post('/pos/sale/report/filter', 'Admin\PosController@posReportFilter')->name('pos-sale-report-filter');
Route::post('/pos/sale/auto', 'Admin\PosController@AutocompltegetAutocomplte')->name('Autocomplte.getAutocomplte');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/checkout/instamojo/notify', 'Front\InstamojoController@notify')->name('instamojo.notify');
   ...
   Route::post('/amarpay/submit', 'Front\CheckoutController@amarpay')->name('amarpay.submit');
